package com.nicolas.coding.third;/*
...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public MyPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        myFirstExtraPdddingLeft = getResources().getDimensionPixelSize(com.nicolas.coding.R.dimen.my_pager_sliding_tab_strip_first_padding_left);

        myPaddingLeft = getResources().getDimensionPixelSize(com.nicolas.coding.R.dimen.my_pager_sliding_tab_strip);
        myPaddingLeft = 0;
...
//
//		addTab(position, tab);
        View v = mInflater.inflate(com.nicolas.coding.R.layout.imageview_head, null, false);
        ImageView head = (ImageView) v.findViewById(com.nicolas.coding.R.id.head);
        if (url.isEmpty()) {
            head.setImageResource(com.nicolas.coding.R.drawable.icon_all_task);
...
//        if (position == 0) {
//            View v = tab.findViewById(com.nicolas.coding.R.id.layout);
