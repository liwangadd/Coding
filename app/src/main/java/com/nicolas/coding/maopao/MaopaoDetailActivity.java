...
import com.nicolas.coding.common.comment.HtmlCommentHolder;
...
//            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.nicolas.coding.R.id.action_copy:
                action_copy();
                return true;
...
//    private UMSocialService mController = UMServiceFactory.getUMSocialService("com.nicolas.coding");
