...
package com.nicolas.coding.maopao.share;
...
import com.nicolas.coding.AllThirdKeys;
...
import com.nicolas.coding.common.widget.IconTextView;
import com.nicolas.coding.model.Maopao;
import com.nicolas.coding.user.UsersListActivity;

public class CustomShareBoard extends PopupWindow implements OnClickListener {

    private static UMSocialService mController = UMServiceFactory.getUMSocialService("com.nicolas.coding");
...
//            }
    ...
    private void addButton(IconTextView.Data data) {
        ...
        LayoutParams lp = iconTextView.getLayoutParams();
