...
import com.nicolas.coding.project.init.create.ProjectCreateActivity_;
import com.nicolas.coding.task.add.TaskAddActivity_;
import com.nicolas.coding.user.AddFollowActivity_;
...
public class ProjectFragment extends BaseFragment implements ProjectListFragment.UpdateData, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String RECEIVER_INTENT_REFRESH_PROJECT = "com.nicolas.coding.project.receiver.refresh";
    ...
    @ViewById
    com.nicolas.coding.third.WechatTab tabs;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (type == Type.Main) {
            inflater.inflate(com.nicolas.coding.R.menu.menu_fragment_project, menu);
        } else {
